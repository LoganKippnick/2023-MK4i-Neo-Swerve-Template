...
public class SwerveSys extends SubsystemBase {
    ...
    private final SwerveModule frontLeftMod = 
        new SwerveModule(
            ...
            CANDevices.frontLeftRotationMtrId,
    ...
    private final SwerveModule frontRightMod = 
        new SwerveModule(
            ...
            CANDevices.frontRightRotationMtrId,
    ...
    private final SwerveModule rearLeftMod = 
        new SwerveModule(
            ...
            CANDevices.rearLeftRotationMtrId,
    ...
    private final SwerveModule rearRightMod = 
        new SwerveModule(
            ...
            CANDevices.rearRightRotationMtrId,
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("front left rotation encoder", frontLeftMod.getRotationEncoderAngle().getDegrees());
        SmartDashboard.putNumber("front right rotation encoder", frontRightMod.getRotationEncoderAngle().getDegrees());
        SmartDashboard.putNumber("rear left rotation encoder", rearLeftMod.getRotationEncoderAngle().getDegrees());
        SmartDashboard.putNumber("rear right rotation encoder", rearRightMod.getRotationEncoderAngle().getDegrees());
    ...
    public SwerveModuleState[] getModuleStates() {
        ...
        return new SwerveModuleState[] {
            new SwerveModuleState(frontLeftMod.getCurrentVelocityMetersPerSecond(), frontLeftMod.getRotationEncoderAngle()),
            new SwerveModuleState(frontRightMod.getCurrentVelocityMetersPerSecond(), frontRightMod.getRotationEncoderAngle()),
            new SwerveModuleState(rearLeftMod.getCurrentVelocityMetersPerSecond(), rearLeftMod.getRotationEncoderAngle()),
            new SwerveModuleState(rearRightMod.getCurrentVelocityMetersPerSecond(), rearRightMod.getRotationEncoderAngle())
        };
