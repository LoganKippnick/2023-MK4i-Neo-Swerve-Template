...
public class SequentialLEDAnimation extends LEDAnimation {

    private LEDAnimation currentAnimation;
    private LEDAnimation[] animations;

    private int currentAnimationIndex;

    private LEDStrip ledStrip;

    public SequentialLEDAnimation(LEDStrip ledStrip, LEDAnimation... animations) {
        super(ledStrip);
