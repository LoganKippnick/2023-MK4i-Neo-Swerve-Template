...
public class CenterCubeDock extends SequentialCommandGroup {
    
    public CenterCubeDock(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys, LightsSys lightsSys) {
        super(
