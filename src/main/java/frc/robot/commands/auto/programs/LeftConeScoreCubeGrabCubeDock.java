...
public class LeftConeScoreCubeGrabCubeDock extends SequentialCommandGroup {
    
    public LeftConeScoreCubeGrabCubeDock(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys) {
        super(
