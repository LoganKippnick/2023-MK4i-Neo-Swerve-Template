...
public class CenterRightCubeMobilityDock extends SequentialCommandGroup {
    
    public CenterRightCubeMobilityDock(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys) {
        super(
            // FIXME: Set pose
