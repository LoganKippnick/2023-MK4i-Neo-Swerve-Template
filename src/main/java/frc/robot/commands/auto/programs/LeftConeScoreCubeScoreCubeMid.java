...
public class LeftConeScoreCubeScoreCubeMid extends SequentialCommandGroup {
    ...
    public LeftConeScoreCubeScoreCubeMid(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys, LightsSys lightsSys) {
        super(
            ...
            new FollowTrajectoryCmd("LeftStartToScoreCube1", 3.375, 2.5, swerveSys).alongWith(
            ...
            new FollowTrajectoryCmd("LeftScoreCube1ToScoreCube2Mid", 3.375, 2.5, swerveSys).alongWith(
