...
public class CenterLeftCubeDock extends SequentialCommandGroup {
    
    public CenterLeftCubeDock(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys) {
        super(
            // FIXME: Set pose
