...
public class CenterConeMobilityDock extends SequentialCommandGroup {
    
    public CenterConeMobilityDock(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys, LightsSys lightsSys) {
        super(
